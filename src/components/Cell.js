...
function Cell(props){      
  return(
    <React.Fragment>
      <div id={props.cell.id} onContextMenu={(e) => (e.preventDefault(), props.rightClickHandler(props.cell.x, props.cell.y, props.cell.id))} style={getStyle(props.cell.flagged)}></div>
    </React.Fragment>
  );
}
